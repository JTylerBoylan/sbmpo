...
stats = sbmpo_stats("../results/car_model/stats.csv");
plans = sbmpo_results("../results/car_model/results.csv");
obstacles = sbmpo_obstacles("../results/car_model/obstacles.csv");
