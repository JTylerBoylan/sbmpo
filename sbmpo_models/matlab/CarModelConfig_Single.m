...
MaxIterations = 10000;
MaxGenerations = 100;
SampleHorizonTime = 1.0;
GoalThreshold = 0.50;

NumberOfStates = 5;
NumberOfControls = 2;
NumberOfGriddedStates = 3;
InitialState = [0, 0, 1.5707, 0, 0];
GoalState = [5, 5, 0, 0, 0];
GridActiveStates = [1, 1, 1, 0, 0];
GridResolution = [0.125, 0.125, 0.0982];
...
for r = 1:runs
 ...
 writecell(Configuration, '../config/car_model_config.csv', 'Delimiter', ',')
