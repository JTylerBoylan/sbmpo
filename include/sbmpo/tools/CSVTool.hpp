...
void append_node_path(const std::string& nodes_file, const std::vector<NodePtr>& nodes) {
...
void append_nodes(const std::string& nodes_file, const std::vector<NodePtr>& nodes) {
